...
import com.daycare.daycareteacher.databinding.TestFragmentDailySheetBinding
...
class TestDailySheetFragment : Fragment(), IAdapterFragmentCallBack {


    private lateinit var binding: TestFragmentDailySheetBinding
    ...
    override fun onCreateView(
        ...
        val view: View = inflater.inflate(R.layout.test_fragment_daily_sheet, container, false)
        binding = TestFragmentDailySheetBinding.bind(view)
    ...
    private fun initView(view: View) {
        ...
        viewModel.getClassDataSample(view)
