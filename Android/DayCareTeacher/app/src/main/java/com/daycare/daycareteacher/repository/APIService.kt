...
import com.daycare.daycareteacher.utill.WebServices
...
import com.daycare.daycareteacher.utill.WebServices.GET_ALL_DAILY_SHEET
...
import com.daycare.daycareteacher.utill.WebServices.GET_BITING_INCIDENT_DETAILS
...
import com.daycare.daycareteacher.utill.WebServices.GET_OPERATIONAL_CLASSSES
...
import com.daycare.daycareteacher.utill.WebServices.GET_STUDENT_ALLERGY
...
import com.daycare.daycareteacher.utill.WebServices.GET_UNREAD_MESSAGE_COUNT
...
import com.daycare.daycareteacher.utill.WebServices.SAVE_STUDENT_IMAGE
import com.daycare.daycareteacher.utill.WebServices.SEND_DAILYSHEET_MAIL
...
import com.daycare.daycareteacher.utill.WebServices.UPDATE_STUDENT_PROFILE_PIC_BY_TEACHER
...
interface APIService {
    ...
    @POST(GET_OPERATIONAL_CLASSSES)
    fun getOperationalClasses(@Body classes: OperationalClassRequestData): Observable<OperationalClassModel>
    ...
    @POST(GET_BITING_INCIDENT_DETAILS)
    fun getBitingIncident(@Body data: IncidentData): Observable<BitingModel>

    @POST(GET_STUDENT_ALLERGY)
    fun getAllergy(@Body data: AllergyData): Observable<AllergyModel>
    ...
    fun teacherCheckInCheckOut(@Body requestData: ClassLogData): Observable<TeacherClassCheckInModel>
    ...
    fun getStudentBreakStatus(@Body requestData: BreakData): Observable<BreakData>   //Breaks
    ...
    fun getUnreadMessageCount(@Body requestData: TeacherChatList): Observable<UnReadMessageResponse>

    @POST(GET_CHAT_HISTORY)
    fun getChatHistory(@Body requestData: ChatData): Observable<ChatHistoryModel>

    @POST(UPDATE_STUDENT_PROFILE_PIC_BY_TEACHER)
     fun updatestudentProfile(@Body requestData: ProfileUploadByTeacherData): Observable<MultipleImageUploadResponse>

    @POST(WebServices.SAVE_TRANSFER_CLASS)
    fun saveTransferClass(@Body data: TransferClassRequest): Observable<BaseModel>

    @POST(WebServices.TRANSFER_CLASS)
    fun getTransferClass(@Body data: TransferClassRequest): Observable<ClassModel>

    @POST(SEND_DAILYSHEET_MAIL)
    fun sendDailySheetEmail(@Body data: SendDailySheetRequest): Observable<SendDailySheetRequest>

    @POST(SAVE_STUDENT_IMAGE)
    fun updateStudentProfileImage(@Body data: UploadProfileImage): Observable<BaseModel>

     @POST(GET_ALL_DAILY_SHEET)
    fun getAllDailySheet(@Body data: DailySheetRequest):Observable<DailySheetStudentList>
