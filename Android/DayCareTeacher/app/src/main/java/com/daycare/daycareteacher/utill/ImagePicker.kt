...
import com.daycare.daycareteacher.BuildConfig
...
object ImagePicker {
    ...
    fun getPickImageIntent(context: Context): Intent? {
        ...
        val uri = FileProvider.getUriForFile(context, BuildConfig.APPLICATION_ID + ".fileprovider", getTempFile(context))
    ...
    public fun getRotation(context: Context, imageUri: Uri, isCamera: Boolean): Int {
        val rotation: Int
        if (isCamera) {
