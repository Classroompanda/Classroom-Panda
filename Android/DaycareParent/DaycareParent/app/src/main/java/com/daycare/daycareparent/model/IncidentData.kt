...
class IncidentData() : Parcelable {
    ...
    var firstAidAdministeredName: String? = null
    ...
    constructor(parcel: Parcel) : this() {
        ...
        parentComment=parcel.readString()
        isAcknowledge = parcel.readValue(Boolean::class.java.classLoader) as? Boolean
    ...
    override fun writeToParcel(parcel: Parcel, flags: Int) {
        ...
        parcel.writeValue(isAcknowledge)
