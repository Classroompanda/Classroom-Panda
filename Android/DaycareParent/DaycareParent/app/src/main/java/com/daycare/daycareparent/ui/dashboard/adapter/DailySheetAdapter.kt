...
import com.daycare.daycareparent.databinding.DailysheetListItemBinding
import com.daycare.daycareparent.interfaces.IAdapterFragmentCallBack
import com.daycare.daycareparent.model.DailySheetStudentData
            ...
            for (l in 0 until 3) {
                ...
                when (l) {
                    ...
                    2->{
                        ...
                        binding.viewMoreBtn.setText("+"+(childrenList!!.get(position).totalActivityCount!! - 2).toString())
                    }
