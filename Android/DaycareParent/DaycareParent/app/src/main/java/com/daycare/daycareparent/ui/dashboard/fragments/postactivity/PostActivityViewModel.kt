...
class PostActivityViewModel():ViewModel() {
   ...
   */
    ...
    fun deletePostActivity(view: View, id: Int?, position: Int) {
        ...
        body.isDeleted=true
        body.selectedStudents= AppInstance.postActivityDetailData?.get(position)?.selectedStudents as java.util.ArrayList<Int>?
        body.postActivityImages=AppInstance.postActivityDetailData?.get(position)?.postActivityImages as java.util.ArrayList<PostActivityImage>
        body.postActivityVideos=AppInstance.postActivityDetailData?.get(position)?.postActivityVideos as java.util.ArrayList<PostActivityVideo>
    ...
    fun uploadImage(view:View,img1:String,img2:String,img3:String)
    {
        ...
        if(I1 && !I2 && !I3) {
            ...
            manager.createApiRequest(ApiUtilis.getAPIService(view.context).multipleImageUpload2(imagenPerfil1,imagenPerfil2,map), object :
                ServiceListener<MultipleImageUploadResponse> {
                override fun getServerResponse(response: MultipleImageUploadResponse, requestcode: Int) {
            ...
            manager.createApiRequest(ApiUtilis.getAPIService(view.context).multipleImageUpload2(imagenPerfil2,imagenPerfil3,map), object :
                ServiceListener<MultipleImageUploadResponse> {
                override fun getServerResponse(response: MultipleImageUploadResponse, requestcode: Int) {
            ...
            manager.createApiRequest(ApiUtilis.getAPIService(view.context).multipleImageUpload2(imagenPerfil1,imagenPerfil3,map), object :
                ServiceListener<MultipleImageUploadResponse> {
                override fun getServerResponse(response: MultipleImageUploadResponse, requestcode: Int) {
            ...
            manager.createApiRequest(ApiUtilis.getAPIService(view.context).multipleImageUpload(imagenPerfil1,imagenPerfil2,imagenPerfil3,map), object :
                ServiceListener<MultipleImageUploadResponse> {
                override fun getServerResponse(response: MultipleImageUploadResponse, requestcode: Int) {
