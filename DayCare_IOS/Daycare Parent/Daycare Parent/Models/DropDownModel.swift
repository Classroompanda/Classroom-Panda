...
public class DropDownModel {
    ...
    public class func modelsFromDictionaryArray(array:Array<Dictionary<String,Any>>) -> [DropDownModel]
    {
        var models:[DropDownModel] = []
        for item in array
        {
            models.append(DropDownModel(dictionary: item)!)
        }
        return models
    }
