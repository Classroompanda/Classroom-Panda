...
public class StudentInformation : NSObject{
	...
	public var studentImmunizations : Array<Immunization>?
	public var studentAllergies : Array<Allergies>?
	public var studentMedications : Array<Medication>?
	public var studentDisabilities : Array<Disability>?
	public var enrolledClassesInformation : Array<Enrollment>?
	public var id : Int?
    ...
    public class func modelsFromDictionaryArray(array:Array<Dictionary<String,Any>>) -> [StudentInformation]
    {
        var models:[StudentInformation] = []
        for item in array
        {
            models.append(StudentInformation(dictionary: item)!)
        }
        return models
    }
	...
	required public init?(dictionary: Dictionary<String,Any>) {
        ...
        if (dictionary["studentImmunizations"] != nil) { studentImmunizations = Immunization.modelsFromDictionaryArray(array: dictionary["studentImmunizations"] as? Array<Dictionary<String,Any>> ?? []) }
        if (dictionary["studentAllergies"] != nil) { studentAllergies = Allergies.modelsFromDictionaryArray(array: dictionary["studentAllergies"] as? Array<Dictionary<String,Any>> ?? []) }
        if (dictionary["studentMedications"] != nil) { studentMedications = Medication.modelsFromDictionaryArray(array: dictionary["studentMedications"] as? Array<Dictionary<String,Any>> ?? []) }
        if (dictionary["studentDisabilities"] != nil) { studentDisabilities = Disability.modelsFromDictionaryArray(array: dictionary["studentDisabilities"] as? Array<Dictionary<String,Any>> ?? []) }
        if (dictionary["enrolledClassesInformation"] != nil) { enrolledClassesInformation = Enrollment.modelsFromDictionaryArray(array: dictionary["enrolledClassesInformation"] as? Array<Dictionary<String,Any>> ?? []) }
