...
class ChangePasswordVC: BaseViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.setNavigationBarWithBackButton(title: Macros.NavigationTitle.changePassword)
