...
public class ActivityDiper: NSObject {
	public var id : Int?
	public var agencyID : Int?
	public var studentActivitiesID : Int?
	public var diaperChangeTime : String?
	public var studentActivityDiaperNote : String?
    ...
    public class func modelsFromDictionaryArray(array:Array<Dictionary<String,Any>>) -> [ActivityDiper]
    {
        var models:[ActivityDiper] = []
        for item in array
        {
            models.append(ActivityDiper(dictionary: item)!)
        }
        return models
    }
	...
	required public init?(dictionary: Dictionary<String,Any>) {
		...
		diaperChangeTime = dictionary["diaperChangeTime"] as? String ?? ""
		studentActivityDiaperNote = dictionary["studentActivityDiaperNote"] as? String ?? ""
	...
	public func dictionaryRepresentation() -> Dictionary<String,Any> {
		...
		dictionary.setValue(self.diaperChangeTime, forKey: "diaperChangeTime")
		dictionary.setValue(self.studentActivityDiaperNote, forKey: "studentActivityDiaperNote")
