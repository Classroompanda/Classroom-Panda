...
public class ActivityNotes: NSObject {
	public var id : Int?
    ...
    public class func modelsFromDictionaryArray(array:Array<Dictionary<String,Any>>) -> [ActivityNotes]
    {
        var models:[ActivityNotes] = []
        for item in array
        {
            models.append(ActivityNotes(dictionary: item)!)
        }
        return models
    }
	...
	public func dictionaryRepresentation() -> Dictionary<String,Any> {
		...
		dictionary.setValue(self.noteDescription, forKey: "noteDescription")
