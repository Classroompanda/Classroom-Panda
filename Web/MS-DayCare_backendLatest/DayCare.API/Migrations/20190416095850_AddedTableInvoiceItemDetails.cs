...
{
    public partial class AddedTableInvoiceItemDetails : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    InvoiceItemDetailsID = table.Column<long>(nullable: false)
                    ...
                    ClassFeePaid = table.Column<long>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvoiceItemDetails", x => x.InvoiceItemDetailsID);
                });
        }
