...
{
    public partial class AddTableTextMessagePlan : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TextMessagePlan",
                columns: table => new
                {
                    ...
                    TextMessagePlanID = table.Column<long>(nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TextMessagePlan", x => x.TextMessagePlanID);
                });
        }
