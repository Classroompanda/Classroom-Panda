...
namespace DayCare.Service.Common
{
    public class CommonEnum
    {
        ...
        public static class EncryptDecryptKey
        {
            ...
            public static string EDKey = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";
        }
        ...
        public static class HCOrganizationConnectionStringEnum
        {
            ...
            public const string Host = "SDN -522";
            ...
            //public const string Host = "HC_Patient_Merging";
            //public const string DomainUrl = "smarthealth.net.in";
        }
        ...
        public enum HttpStatusCodes
        {
            ...
            MissingParameter = 986,// Section 10.5.6: HTTP Ve           
            SomethingWentWrong = 987 // Something Wend Wrong
        }
