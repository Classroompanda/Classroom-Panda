...
@Component({
    ...
    templateUrl: './agency-admin-event-planner.component.html',
    styleUrls: ['./agency-admin-event-planner.component.css']
})
export class AgencyAdminEventPlannerComponent implements OnInit {
    display: boolean;
    cars: any[] = [];
    events: any[];
    options: any;
