...
import {
  ActivityVM, MealVM, HealthVM, MoodVM, NotesVM,
  DailySheetList, MoodList, NapVM, DiperVM
} from '../../shared/view-model/daily-activityVM';

declare var $: any;
@Component({
  selector: 'app-teacher-daily-activity',
  templateUrl: './teacher-daily-activity.component.html',
  styleUrls: ['./teacher-daily-activity.component.css']
})
export class TeacherDailyActivityComponent implements OnInit, AfterViewInit {
  classList: any[] = [];
  serchByClass = '';
  searchByDate: any;
