...
@Component({
  ...
  templateUrl: './teacher-studentbreak.component.html',
  styleUrls: ['./teacher-studentbreak.component.css']
})
export class TeacherStudentbreakComponent implements OnInit {
  breakList: any[] = [];
  studentId: any;
  attendanceId: any;
